...
<html>
<head>
    <title>江西财经职业学院新冠肺炎疫情实时动态播报</title>
    <meta charset="UTF-8">
...
<div class="container">
    <div class="col-md-offset-2">
        <div class="row">
            <img src="img/bg0.png" height="450" width="788">
        </div>
        ...
        <div class="panel3">
            ...
            <h2 style="color: white">江西财经职业学院新冠肺炎疫情实时动态播报</h2>
        </div>
            ...
            <div>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li>
                            <a href="${pageContext.request.contextPath}/view/frontweb/stulogin.jsp" class="tooltip-show" data-toggle="tooltip" title="登录打卡并查看学生信息">学生打卡</a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/view/frontweb/tealogin.jsp" class="tooltip-show" data-toggle="tooltip" title="登录打卡并查看教师信息">教师打卡</a>
                        </li>
                        <%--<li>
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/view/StuAndTeaLogin/login.jsp" class="tooltip-show" data-toggle="tooltip" title="学生/老师查看信息">学生/老师</a>
                        </li>
        ...
        <div class="news">
            <div style="padding-top: 20px; padding-left: 20px">
                <c:forEach items="${newsArrayList}" var="news" varStatus="s">
                    ...
                    <p class="right" style="padding-top: 3px; color: #7B7B7B">
        ...
        <footer class="navbar-fixed-bottom footer2">
            <div class="container">
                <div align="center" style="padding-top: 10px; color: #696969">
                    Copyright © 2022 20软件技术1班刘国强 20号 版权所有
                </div>
            </div>
        </footer>

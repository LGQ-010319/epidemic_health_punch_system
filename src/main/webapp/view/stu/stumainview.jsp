    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" href="#" title="logoTitle">财校疫情防控管理信息系统</a>
            </div>
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li role="presentation">
                        <a href="${pageContext.request.contextPath}/view/StuAndTeaLogin/login.jsp"><span class="fa fa-power-off"></span> 退出登录</a>
                    </li>
                </ul>
            </div>
        </div>
